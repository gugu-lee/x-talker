...
namespace BogheCore.Model
{
    public class Configuration : BaseObject
    {
        ...
        public enum ConfEntry
        {
            ...
            /* === QOS/QOE === */
            PRECOND_STRENGTH, PRECOND_TYPE, BANDWIDTH, PREF_VIDEO_SIZE, SESSION_TIMERS_REFRESHER, SESSION_TIMERS_TIMEOUT, SIP_SESSIONS_TIMEOUT, SESSION_TIMERS, ZERO_VIDEO_ARTIFACTS,
