...
#include	<stdio.h>
#include	"thig_platform.h"			/**< platform-specific defines */
...
#define MAX_BLK_CNT		1		/**< max # blocks per call in TestTwofish */

/**Performs a test 
 * 
 * @param mode - the mode in which Twofish operates (EBC, CBC etc)
 * @param keySize - length of key used
 * @returns - 0 if tests ok , 1 on error
 */
